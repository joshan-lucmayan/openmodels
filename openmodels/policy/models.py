...
OpenModels is attacker-oriented, but its deployment layer must know what it is
...
from openmodels.models import Target, new_id, utcnow


class Operation(str, Enum):
    """Operations an OpenModels instance may perform."""
