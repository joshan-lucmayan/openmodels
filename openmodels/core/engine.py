...
from openmodels.attack.planner import AttackPlanner, default_planner
...
from openmodels.policy.models import Operation, Policy, StopReason
...
class AdversarialEngine:
    ...
    def _record_regression(
        ...
        from openmodels.models import Experiment, Regression, TestSpec
